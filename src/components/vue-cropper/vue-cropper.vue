    ...
    methods: {
                ...
                if (this.canChangeX) {
                    if (this.changeCropTypeX === 1) {
                        if (this.cropOldW - fw > 0) {
                            ...
                            this.cropW =
                                Math.abs(fw) + this.cropChangeX <= wrapperW ? Math.abs(fw) - this.cropOldW : wrapperW - this.cropOldW - this.cropChangeX
                ...
                if (this.canChangeY) {
                    if (this.changeCropTypeY === 1) {
                        if (this.cropOldH - fh > 0) {
                            ...
                            this.cropH =
                                Math.abs(fh) + this.cropChangeY <= wrapperH ? Math.abs(fh) - this.cropOldH : wrapperH - this.cropOldH - this.cropChangeY
        ...
        getCropBlob(cb) {
            this.getCropChecked(data => {
                ...
                data.toBlob(blob => cb(blob), 'image/jpg', this.outputSize)
            })
        },
        ...
        if (!HTMLCanvasElement.prototype.toBlob) {
            Object.defineProperty(HTMLCanvasElement.prototype, 'toBlob', {
                value: function(callback, type, quality) {
                    ...
                    callback(new Blob([arr], { type: that.type || 'image/jpeg' }))
                }
            })
        }
        this.showPreview()
